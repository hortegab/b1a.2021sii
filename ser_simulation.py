...
class ser_simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.const0 = const0 = digital.constellation_8psk().points()
        self.Sps = Sps = 1
        self.run_stop = run_stop = True
        self.Rs = Rs = samp_rate/Sps
        self.N_snr = N_snr = 128
        self.MiconstellationObject0 = MiconstellationObject0 = digital.constellation_calcdist(const0, (0,1,2,3,4,5,6,7),
