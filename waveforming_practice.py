...
class waveforming_practice(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.b_upconverter_cf_0, 0))
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.qtgui_const_sink_x_0_1, 0))
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.qtgui_const_sink_x_0_1_0, 0))
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
